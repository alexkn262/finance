...
<form method="post" action="<?= base_url('/admin/settings') ?>" class="admin-form">
    ...
    <label>AdSense Auto Ads Code <textarea name="adsense_code" rows="4"><?= e($settings['adsense_code'] ?? '') ?></textarea></label>
    <label>OpenAI API Key (articles) <input type="text" name="openai_api_key" value="<?= e($settings['openai_api_key'] ?? '') ?>"></label>
    <label>Paraphrase API 1 (ApyHub) <input type="text" name="paraphrase_api_1" value="<?= e($settings['paraphrase_api_1'] ?? '') ?>"></label>
    <label>Paraphrase API 2 (MeaningCloud) <input type="text" name="paraphrase_api_2" value="<?= e($settings['paraphrase_api_2'] ?? '') ?>"></label>
    <label>Paraphrase API 3 (TextGears) <input type="text" name="paraphrase_api_3" value="<?= e($settings['paraphrase_api_3'] ?? '') ?>"></label>
    <label>Paraphrase API 4 (Backup) <input type="text" name="paraphrase_api_4" value="<?= e($settings['paraphrase_api_4'] ?? '') ?>"></label>
